...
public class InventoryItemUnlockedEventHandler : INotificationHandler<InventoryItemUnlockedDomainEvent>
{
    ...
    public Task Handle(InventoryItemUnlockedDomainEvent notification, CancellationToken cancellationToken)
    {
