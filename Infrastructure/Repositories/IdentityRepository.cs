...
public class IdentityRepository : RepositoryBase, IIdentityRepository
{
    ...
    public IdentityRepository(IDatabaseContextWrapper databaseContextWrapper, ICacheService cacheService, UserManager<User> userManager) : base(databaseContextWrapper, cacheService)
    {
