...
public class WalletServiceTests
{
    ...
    private readonly int DEFAULT_CASH_VALUE = 150;
    ...
    public async Task GetWallet_CreateUserThenGetWallet_ReturnsUsersWallet()
    {
        ...
        userStub.UpdateCashAmount(DEFAULT_CASH_VALUE);

        CreateUser(userStub);

        var queryStub = new GetUserWalletQuery { UserId = DEFAULT_USER_ID };
    ...
    public async Task UpdateWallet_CreateUserThenUpdateWallet_ReturnsUpdatedWallet()
    {
        ...
        int newCashAmount = DEFAULT_CASH_VALUE + 100;
    ...
    public async Task GetUserCash_CreateUserThenGetUserCashAmount_ReturnsUsersCashAmount()
    {
        ...
        var queryStub = new GetUserCashQuery { UserId = DEFAULT_USER_ID };
        ...
        Assert.True(userCashAmount == DEFAULT_CASH_VALUE, "The user cash amount has to be equal to the cash amount that was added");
    }
    ...
    public async Task TakeCash_CreateUserThenTakeMoreCashThanTheUserHas_ReturnsFalse()
    {
        ...
        int takenAmount = DEFAULT_CASH_VALUE + 100;
    ...
    public async Task GiveCash_CreateUserThenGiveCash_ReturnsTrue(int givenAmount)
    {
        ...
        var result = await _sut.GetUserCashAsync(new GetUserCashQuery { UserId = DEFAULT_USER_ID });

        // Assert

        Assert.True(giveCashResult, "The result has to be true");
        Assert.Equal(DEFAULT_CASH_VALUE + givenAmount, result);
    }
    ...
    public async Task GiveCash_CreateUserThenGiveInvalidCashToUser_ReturnsFalse(int givenAmount)
    {
        ...
        Assert.Equal(DEFAULT_CASH_VALUE, result);
    }
